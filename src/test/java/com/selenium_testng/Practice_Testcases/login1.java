...
public void ValidateLoginFeature(){
  ...
  //  driver.findElement(By.xpath("//div/button[@type='submit']")).click();
   ...
   boolean ans = driver.findElement(By.xpath("//h6[text()='Dashboard']")).getText().equals("Dashboard");
    Assert.assertTrue(ans);
    ScreenshotListener.captureThis("Login", driver);
...
public void ValidateAssignLeave() throws InterruptedException {
    ...
    boolean ans = driver.findElement(By.xpath("//h6[text()='Leave']")).getText().equals("Leave");
    Assert.assertTrue(ans,"Page not loaded properly");
    if (ans) {
        ...
        List <WebElement> ls = driver.findElements(By.xpath("//div[@role='listbox']"));
          ...
          ScreenshotListener.captureThis("VallidateAssignKeave", driver);
